...
Otra paleta de colores muy conocida es `viridis` que tiene colores especialmente pensados para poder ser distinguidos por personas con daltonismo
...
```{r themes1, echo=FALSE, fig.align= "center", fig.height=5, fig.width=7}
...
```{r themes2, echo=FALSE, fig.align= "center", fig.height=5, fig.width=7}
library(tidyverse)
library(gridExtra)
options(warn=-1)
p <- ggplot(mtcars) + geom_point(aes(x = wt, y = mpg,
