...
background-image: url(fondo_piola.jpg)
...
me permite observar cuantos puntos presenta la distribución

```{r cajajitter, echo=TRUE, fig.align= "center", fig.height=5, fig.width=7}
library(tidyverse)
library(datos)
ggplot(data = millas, mapping = aes(x = clase, y = autopista)) +
  geom_boxplot()+
...
```{r cajaj2, echo=TRUE, fig.align= "center", fig.height=4, fig.width=6}
